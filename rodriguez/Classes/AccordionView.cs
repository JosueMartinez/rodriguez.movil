...
namespace rodriguez
{
	...
	public class ProductosTemplate: AbsoluteLayout
	{
		public ProductosTemplate(){
			this.Padding = 5;
			this.HeightRequest = 50;
			...
			this.Children.Add(product, new Rectangle(0.5, 0.5, 0.9, 1), AbsoluteLayoutFlags.All);
			product.SetBinding(Label.TextProperty,  "nombre");
